...
for k in k_array:
    for power in power_array:
        for nor in nor_array:
            kmer_linear_density = np.load("data/linear_features/linear/0320/k" + str(k) + "p" + str(power) + "nor" + str(nor) + ".npy")
            for num in num_array:
                ...
                print(data_x.shape)
                np.save("data/linear_features/point/0320/k" + str(k) + "p" + str(power) + "nor" + str(nor) + "n" + str(num), data_x)